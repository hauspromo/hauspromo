        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <Card className="bg-gradient-to-br from-white to-blue-50 border-0 shadow-xl">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl font-bold text-gray-900">Sam</CardTitle>
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-6 text-white">
              ...
              <p className="mb-4">Let Sam show you the insider secrets to dominating social media algorithms and achieving viral success for your brand.</p>
